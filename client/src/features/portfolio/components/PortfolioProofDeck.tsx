      ...
      <div className="relative grid gap-px bg-white/10 lg:grid-cols-[0.72fr_1.28fr]">
        <div className="bg-[#07111f]/96 p-4 sm:p-5">
          <div className="flex items-center justify-between gap-4">
            ...
            <span className="relative h-2.5 w-2.5 shrink-0 rounded-full bg-[#67e8f9] shadow-[0_0_16px_rgba(103,232,249,0.85)] motion-safe:animate-pulse" aria-hidden="true" />
          </div>
        ...
        <div key={active.id} className="relative bg-[#08182a] p-4 sm:p-5 motion-safe:animate-[fadeIn_220ms_ease-out]">
          ...
          <h3 className="mt-2 font-display text-[clamp(1.65rem,3vw,2.6rem)] font-medium leading-[0.95] tracking-[-0.045em] text-white">{active.title}</h3>
