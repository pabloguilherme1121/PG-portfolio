      ...
      <div className="relative mx-auto flex min-h-[604px] max-w-[1440px] flex-col justify-between px-5 pb-8 pt-12 sm:min-h-[774px] sm:px-8 sm:pt-24 lg:px-12">
        <div className="relative max-w-4xl">
          ...
          <div className="reveal delay-2 mt-9 flex max-w-xl flex-col gap-6 sm:ml-[16.8%]">
            ...
            </div> : <div data-showreel-fallback="true" className="mt-6 border border-[#67e8f9]/25 bg-[#050c16]/90 px-5 py-6" role="status"><p className="font-mono text-[9px] uppercase tracking-[0.15em] text-[#67e8f9]">arquivo em movimento</p><p className="mt-2 font-body text-sm text-[#b9d4ee]">Showreel em preparação. Conheça os projetos e formatos disponíveis abaixo.</p></div>}
          </div>
        </div>
