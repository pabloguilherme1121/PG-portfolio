  ...
  return (
    <footer id="contato-rodape" className="border-t border-white/[0.07] bg-[#06080d]" aria-labelledby="footer-contact-title">
      <div className="mx-auto grid max-w-[1440px] gap-8 px-5 py-10 sm:px-8 lg:grid-cols-[1.2fr_1fr_1fr] lg:px-12">
        <div>
          <div className="flex items-center gap-3"><img src={markUrl} alt="" width="24" height="24" decoding="async" className="h-6 w-6 object-contain" /><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-[#7b91b3] light-muted-ink">Pablo Guilherme · desenvolvimento web & audiovisual</p></div>
