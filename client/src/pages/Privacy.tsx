...
const sections = [
  ["Dados enviados", "O formulário comercial pode receber nome, e-mail, telefone, data desejada, tipo de serviço, localização e briefing. Essas informações são usadas apenas para analisar o pedido, responder e preparar uma proposta."],
    ...
    <main className="min-h-screen bg-[#030b1e] px-5 py-8 text-[#e8f1ff] sm:px-8 lg:px-12">
      <div className="mx-auto max-w-5xl">
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-white/[0.1] pb-6">
          <a href="/" className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.14em] text-[#9eb7dc] transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a5f3fc]">
