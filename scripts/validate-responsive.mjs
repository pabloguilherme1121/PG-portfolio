...
for (const width of viewports) {
  ...
  const audiovisualPreviewProjectCount = await page.getByRole("region", { name: "Prévia do perfil Audiovisual" }).locator("[title]").count();
