...
await page.screenshot({ path: "/home/ubuntu/search-suggestions-icons-validation.png", fullPage: true });
...
console.log(JSON.stringify({ labels, focusVisible, focusMovedByTab, focusedDuringTransition, focusPreservedAfterTransition, selectedState, visibleCards, compactState, compactToggleLabel, compactCardClass, compactFocusPreserved, suggestionCount, projectIconCount, suggestionsExpanded, activeSuggestionId, keyboardSuggestionValue, keyboardSuggestionResultCount, descriptionIconCount, clickSuggestionValue, clickSuggestionResultCount, searchResultCount, searchFeedback, emptySearchMessage, clearedSearchValue, clearedSearchCount, technologySuggestionCount, technologyIconCount, technologySuggestionValue, technologySearchCount, descriptionSearchCount, reducedMotion, transitionClassDuringChange, transitionClassAfterChange }));
await browser.close();
